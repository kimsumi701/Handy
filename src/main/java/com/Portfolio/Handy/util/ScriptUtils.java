package com.Portfolio.Handy.util;
...
public class ScriptUtils {
    ...
    public static void movePage(HttpServletResponse response, String page) throws IOException {
        init(response);
        PrintWriter out = response.getWriter();
        out.println("<script>location.href='" + page + "';</script> ");
        out.flush();
    }
}
